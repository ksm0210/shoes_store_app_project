class Order {
  ...
  String order_status; // 요청, 준비중, 완료
  DateTime created_at;

  String? store_name; // 추가함
  int? product_size; // 추가함
  ...
  Order.fromMap(Map<String, dynamic> res)
    : customer_id = res['customer_id'],
      ...
      product_name = res['product_name'] != null
          ? res['product_name']
          : 'empty',
      product_mainImageUrl = res['product_mainImageUrl'] != null
          ? res['product_mainImageUrl']
          : 'empty',
